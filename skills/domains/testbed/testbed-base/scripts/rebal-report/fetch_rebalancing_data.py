...
def get_json_path(directory, schedule_id):
    """데이터 JSON 파일 경로"""
    return directory / f'rebalancing_data_{schedule_id}.json'
...
def cmd_fetch(args):
    ...
    json_path = get_json_path(out_dir, args.schedule_id)
...
def main():
    ...
    sp_fetch.add_argument('--work-dir', required=True, help='로컬 임시 작업 디렉토리')
